...
const Profile = ({doctorData}) => {
    ...
    const addExperience = e => {
      ...
      addItem('experiences', {
        ...
        hospital:"Dhaka Medical Collage"
      });
    };
        ...
        <div className="mb-5">
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                <option value="">Select</option>
                <option value="surgeon">Sugeon</option>
          ...
          { formData.qualifications?.map((item, index)=>(
            <div key={index}>
              <div>
                ...
                <button onClick={e => deleteQualification(e,index)} className="bg-red-600 rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer">
                  <AiOutlineDelete/>
                </button>
            ...
            <div key={index}>
              <div>
                ...
                <button 
                  ...
                  className="bg-red-600 rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer">
                  <AiOutlineDelete/>
                </button>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  <div className="flex items-center">
                    <button
                      ...
                      className="bg-red-600 rounded-full text-white text-[18px] cursor-pointer mt-6">
                      <AiOutlineDelete/>
                    </button>
                  </div>
                </div>
