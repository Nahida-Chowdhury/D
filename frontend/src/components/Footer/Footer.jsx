...
import { RiLinkedinFill } from 'react-icons/ri'; // Correct icon name
...
const socialLinks = [
  ...
  {
    path: "https://github.com/Nahida-Chowdhury",
      ...
      <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px] ">
        <div>
          ...
          <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
            Copyright© {year} developed by Nahida Ahmed Chowdhury all right reserved.
          </p>
